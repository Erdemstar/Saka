...
namespace authentication_bypass_cookie_sha1.Mvc.Controllers;
...
public class HomeController : Controller
{
    ...
    public IActionResult Attack(IFormCollection form)
    {
        ...
        if (username == "user" && password == "pass")
        {
            ...
            HttpContext.Response.Cookies.Append("Role", "12dea96fec20593566ab75692c9949596833adc9", cookieOptions);
            ViewBag.role = "12dea96fec20593566ab75692c9949596833adc9";
        }
        return View();
    }
